...
class ActivitiesDetail extends StatefulWidget {
  ...
  ActivitiesDetail({required this.activitesData});

  @override
  _ActivitiesDetail createState() => _ActivitiesDetail();
}

class _ActivitiesDetail extends State<ActivitiesDetail> {
  bool isHidden = true;
...
// Hàm để ẩn phần xác nhận xóa
  ...
  Future<void> deleteFertilizer() async {
    final fertilizerId = widget.activitesData['_id'];
          ...
          child: Stack(
            ...
            children: [
              ...
              Positioned(
                ...
                top: 705,
                child: Text(
                  widget.activitesData['instructions'] ?? 'N/A',
                  style: GoogleFonts.getFont(
                    'Noto Sans',
                    color: Colors.black,
                    fontSize: 14,
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 22,
                  child: Text(
                    widget.activitesData['nutrients']['kali'] ?? 'N/A',
                    style: GoogleFonts.getFont(
                      'Noto Sans',
                      color: Colors.black,
                      fontSize: 14,
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 22,
                  child: Text(
                    widget.activitesData['nutrients']['nitro'] ?? 'N/A',
                    style: GoogleFonts.getFont(
                      'Noto Sans',
                      color: Colors.black,
                      fontSize: 14,
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 22,
                  child: Text(
                    widget.activitesData['nutrients']['phosphate'] ?? 'N/A',
                    style: GoogleFonts.getFont(
                      'Noto Sans',
                      color: Colors.black,
                      fontSize: 14,
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 22,
                  child: Text(
                    widget.activitesData['nutrients']['others'] ?? 'N/A',
                    style: GoogleFonts.getFont(
                      'Noto Sans',
                      color: Colors.black,
                      fontSize: 14,
              ...
              Positioned(
                ...
                child: SizedBox(
                  width: 145,
                  child: Text(
                    widget.activitesData['supplier'] ?? 'N/A',
                    style: GoogleFonts.getFont(
                      'Noto Sans',
                      color: Colors.black,
                      fontSize: 14,
              ...
              Positioned(
                ...
                child: SizedBox(
                  width: 145,
                  child: Text(
                    widget.activitesData['fertilizerName'] ?? 'N/A',
                    style: GoogleFonts.getFont(
                      'Noto Sans',
                      color: Colors.black,
                      fontSize: 14,
              ...
              Positioned(
                ...
                top: 377,
                child: Text(
                  widget.activitesData['fertilizerCode'] ?? 'N/A',
                  style: GoogleFonts.getFont(
                    'Noto Sans',
                    color: Colors.black,
                    fontSize: 14,
