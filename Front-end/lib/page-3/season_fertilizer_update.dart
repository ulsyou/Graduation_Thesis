...
class Fertilizer_use_update extends StatefulWidget {
  ...
  @override
  _Fertilizer_use_updateState createState() => _Fertilizer_use_updateState();
}

class _Fertilizer_use_updateState extends State<Fertilizer_use_update> {
  ...
  Future<void> updateFertilizerSeason(String id) async {
    final String apiUrl =
        'http://10.0.2.2:5000/use-fertilizer/UseFertilizer/${widget.fertilizerId}';
    ...
    if (cropSeasonCode != null) {
      ...
      if (response.statusCode == 200) {
        // Change to check for the appropriate status code for a successful update
        print('fertilizer use update successful');
      } else {
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            onTap: () async {
                              await updateFertilizerSeason(
                                  widget.seasonData['_id']);
